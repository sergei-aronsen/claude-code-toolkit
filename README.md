...
| **Integrations catalog**             | TUI installer for 32 MCP servers + 10 companion CLIs across 10 categories (Backend / Payments / Workspace / Project Management / …). Per-row scope. |
...
The `--integrations` flag (or `/integrations` after the first install) opens a TUI checklist with 32 servers across 10 categories. Pick only what your project needs — the rest stays untouched.
