...
**Color coding:** no color (<60%), yellow (60-79%), red (80-89%), bright red (90-100%)
...
The installer checks prerequisites, downloads scripts to `~/.claude/`, configures `settings.json`, and runs an initial probe.
