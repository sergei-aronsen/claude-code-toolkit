...
3. Write ALL tests
4. Ensure tests FAIL (code not yet written or testing existing)
...
### 4. Security Cases (Security)

- Unauthorized access
- Invalid permissions
- Injection attempts (if applicable)

### 5. Integration Cases (Integration)
...
3. **Write** tests following the templates
4. **Verify** that tests are isolated and independent
5. **Run** tests and ensure they work
