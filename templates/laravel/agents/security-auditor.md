...
Perform a deep security audit of the project, focusing on OWASP Top 10 and framework-specific vulnerabilities.
...
2. **Explore** results manually
3. **Check** each finding through self-check
