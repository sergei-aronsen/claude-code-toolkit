...
**DO NOT use deprecated versions:** Claude 3.5, 4.0, Gemini 1.x, 2.x
...
| **Sonnet 4.5** | `claude-sonnet-4-5-20250929` | Daily development, speed/quality balance |
| **Haiku 4.5** | `claude-haiku-4-5-20251001` | Quick tasks, autocomplete, simple operations |
...
| **Gemini 3 Flash** | `gemini-3-flash-preview` | Quick tasks, speed/quality balance |
