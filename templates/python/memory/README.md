...
This directory contains MCP memory exports for synchronization between computers.

## Files

| File | Description |
|------|----------|
| `knowledge-graph.json` | Project entities and relationships (Knowledge Graph) |
