...
### 18. Playwright Service Stability

For comprehensive Playwright Docker configuration (backpressure, browser recycling,
memory monitoring, sizing guide, anti-detection), see
[playwright-stability-guide.md](./playwright-stability-guide.md).

**Quick checklist:**

- `init: true` (zombie killer) + `shm_size: '2g'` (Chrome IPC)
- `MAX_CONCURRENT_PAGES` = Browser Pool × 2 (NOT 150!)
