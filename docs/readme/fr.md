...
| **Catalogue d'intégrations**          | Installeur TUI pour 32 serveurs MCP + 10 CLIs compagnons en 10 catégories (Backend / Payments / Workspace / Project Management / …). Scope par ligne. |
...
Le flag `--integrations` (ou `/integrations` après la première install) ouvre une checklist TUI avec 32 serveurs en 10 catégories. Tu prends seulement ce dont ton projet a besoin.
