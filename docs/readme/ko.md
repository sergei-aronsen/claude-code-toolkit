...
**30개 슬래시 명령어** | **7개 감사** | **30개 가이드** | [명령어, 템플릿, 감사, 컴포넌트 전체 목록](../features.md#slash-commands-30-total) 보기.
