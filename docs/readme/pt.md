...
| **Catálogo de integrações**           | Instalador TUI para 32 servidores MCP + 10 CLIs companion em 10 categorias (Backend / Payments / Workspace / Project Management / …). Scope por linha. |
...
O flag `--integrations` (ou `/integrations` depois da primeira instalação) abre um checklist TUI com 32 servidores em 10 categorias. Você pega só o que o projeto precisa.
