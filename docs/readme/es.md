...
| **Catálogo de integraciones**        | Instalador TUI para 32 servidores MCP + 10 CLIs complementarios en 10 categorías (Backend / Pagos / Workspace / Project Management / …). Scope por fila. |
...
El flag `--integrations` (o `/integrations` después de la primera instalación) abre una checklist TUI con 32 servidores en 10 categorías. Eliges solo lo que tu proyecto necesita.
