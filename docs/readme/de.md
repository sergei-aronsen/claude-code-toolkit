...
| **Integrations-Katalog**             | TUI-Installer für 32 MCP-Server + 10 Companion-CLIs in 10 Kategorien (Backend / Payments / Workspace / Project Management / …). Per-Row-Scope.    |
...
Das Flag `--integrations` (oder `/integrations` nach der ersten Installation) öffnet eine TUI-Checkliste mit 32 Servern in 10 Kategorien. Du wählst nur, was dein Projekt braucht.
