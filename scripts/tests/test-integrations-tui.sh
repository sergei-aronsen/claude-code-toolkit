...
" 2>&1)
assert_contains "labels=24" "$counts_out" "A3: TUI_LABELS has 24 rows"
assert_contains "groups=24" "$counts_out" "A3: TUI_GROUPS parallel-array has 24 rows"
assert_contains "mcp=24" "$counts_out" "A3: MCP_NAMES has 24 rows"
