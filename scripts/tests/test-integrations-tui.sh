...
" 2>&1)
assert_contains "labels=29" "$counts_out" "A3: TUI_LABELS has 29 rows"
assert_contains "groups=29" "$counts_out" "A3: TUI_GROUPS parallel-array has 29 rows"
assert_contains "mcp=29" "$counts_out" "A3: MCP_NAMES has 29 rows"
