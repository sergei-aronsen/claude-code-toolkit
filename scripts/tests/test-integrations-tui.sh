...
" 2>&1)
assert_contains "labels=32" "$counts_out" "A3: TUI_LABELS has 32 rows"
assert_contains "groups=32" "$counts_out" "A3: TUI_GROUPS parallel-array has 32 rows"
assert_contains "mcp=32" "$counts_out" "A3: MCP_NAMES has 32 rows"
