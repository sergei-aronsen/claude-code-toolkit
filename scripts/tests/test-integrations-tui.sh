...
" 2>&1)
assert_contains "labels=23" "$counts_out" "A3: TUI_LABELS has 23 rows"
assert_contains "groups=23" "$counts_out" "A3: TUI_GROUPS parallel-array has 23 rows"
assert_contains "mcp=23" "$counts_out" "A3: MCP_NAMES has 23 rows"
