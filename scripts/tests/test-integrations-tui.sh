...
" 2>&1)
assert_contains "labels=21" "$counts_out" "A3: TUI_LABELS has 21 rows"
assert_contains "groups=21" "$counts_out" "A3: TUI_GROUPS parallel-array has 21 rows"
assert_contains "mcp=21" "$counts_out" "A3: MCP_NAMES has 21 rows"
