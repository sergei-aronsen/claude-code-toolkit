...
" 2>&1)
assert_contains "labels=31" "$counts_out" "A3: TUI_LABELS has 31 rows"
assert_contains "groups=31" "$counts_out" "A3: TUI_GROUPS parallel-array has 31 rows"
assert_contains "mcp=31" "$counts_out" "A3: MCP_NAMES has 31 rows"
