...
" 2>&1)
assert_contains "labels=30" "$counts_out" "A3: TUI_LABELS has 30 rows"
assert_contains "groups=30" "$counts_out" "A3: TUI_GROUPS parallel-array has 30 rows"
assert_contains "mcp=30" "$counts_out" "A3: MCP_NAMES has 30 rows"
