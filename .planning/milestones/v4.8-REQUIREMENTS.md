# Requirements — v4.8 Multi-CLI Bridge
...
- [x] **BRIDGE-DOCS-01**: `docs/BRIDGES.md` (new) documents:
...
- [x] **BRIDGE-DOCS-02**: `docs/INSTALL.md` "Installer Flags" table extended with `--no-bridges`, `--bridges <list>`, `--break-bridge <name>`, `--restore-bridge <name>` rows. README mentions multi-CLI support in the Killer Features grid.
