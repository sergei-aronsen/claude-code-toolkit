...
- [x] **Phase 1: Pre-work Bug Fixes** - Fix the v3.x bugs that would corrupt any complement-mode logic built on top of them (completed 2026-04-21)
- [x] **Phase 2: Foundation** - Ship detect.sh, extend manifest schema, and establish install state with atomic writes and locking (completed 2026-04-21)
- [x] **Phase 3: Install Flow** - Refactor init-claude.sh + init-local.sh for 4-mode installs, dry-run, and safe settings merge (completed 2026-04-21)
- [x] **Phase 4: Update Flow** - Refactor update-claude.sh to re-evaluate state, surface drift, and apply mode-aware skip-lists (completed 2026-04-21)
- [x] **Phase 5: Migration** - Ship migrate-to-complement.sh for existing v3.x users with three-way diff and per-file confirmation (completed 2026-04-21)
...
|-------|----------------|--------|-----------|
| 1. Pre-work Bug Fixes | 7/7 | Complete   | 2026-04-21 |
| 2. Foundation | 3/3 | Complete   | 2026-04-21 |
| 3. Install Flow | 3/3 | Complete   | 2026-04-21 |
| 4. Update Flow | 3/3 | Complete   | 2026-04-21 |
| 5. Migration | 3/3 | Complete   | 2026-04-21 |
