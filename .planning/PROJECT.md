...
---
*Last updated: 2026-04-27 — Phase 21 complete: SP/GSD bootstrap installer shipped (BOOTSTRAP-01..04). Two-prompt pre-install flow before detect.sh; `--no-bootstrap` / `TK_NO_BOOTSTRAP` opt-out; hermetic test (26 assertions) wired into CI Test 28.*
