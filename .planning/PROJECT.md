...
---
*Last updated: 2026-04-27 — Phase 22 complete: smart-update coverage for `scripts/lib/*.sh` shipped (LIB-01, LIB-02). All 6 lib helpers now registered in manifest 4.4.0 under `files.libs[]`; zero `update-claude.sh` code changes (jq auto-discovery); hermetic 5-scenario test wired into CI Test 29. CHANGELOG `[4.4.0]` consolidates Phase 21 + 22.*
