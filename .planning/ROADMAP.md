...
- [ ] 26-01-skills-lib-and-sync-script-PLAN.md — `scripts/lib/skills.sh` (catalog + is_skill_installed + skills_install) + `scripts/sync-skills-mirror.sh` standalone maintainer tool (Wave 1; SKILL-03)
- [ ] 26-02-mirror-content-snapshot-PLAN.md — Commit 22-skill snapshot under `templates/skills-marketplace/` + per-skill license preservation with SKILL-LICENSE.md fallback (Wave 1; SKILL-01, SKILL-02)
- [ ] 26-03-install-sh-skills-page-PLAN.md — `scripts/install.sh --skills` routing branch with TUI page + cp-R install + --force overwrite + dry-run preview (Wave 2; SKILL-03)
...
| 26. Skills Selector | 0/4 | Not started | - |
