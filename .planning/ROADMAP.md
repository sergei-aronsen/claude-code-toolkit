...
- [ ] 07-01-PLAN.md — scripts/validate-release.sh skeleton + 4-invariant helpers + run_cell fail-fast wrapper (VALIDATE-01/02/03)
- [ ] 07-02-PLAN.md — Makefile version-align + translation-drift + agent-collision-static targets wired into make check (VALIDATE-03/04)
