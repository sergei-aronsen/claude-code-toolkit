...
- [x] 15-02-PLAN.md — Test fixtures: audit-report.md + 3 stub backends (COUNCIL-06)
- [x] 15-03-PLAN.md — commands/audit.md Council Handoff UX text: FP nudge + disputed prompt (COUNCIL-01, COUNCIL-05)
- [x] 15-04-PLAN.md — brain.py audit-review mode: argparse, parallel dispatch, in-place rewrite (COUNCIL-01, COUNCIL-02, COUNCIL-03, COUNCIL-04, COUNCIL-06)
- [x] 15-05-PLAN.md — commands/council.md ## Modes section (COUNCIL-01)
- [x] 15-06-PLAN.md — test-council-audit-review.sh + Makefile Test 19 (COUNCIL-02, COUNCIL-03, COUNCIL-05, COUNCIL-06)
...
- [x] 16-03-PLAN.md — Apply splice script to live templates/ (49 prompt files in one atomic commit) (TEMPLATE-01, TEMPLATE-02)
- [x] 16-04-PLAN.md — Wire CI gates: Makefile validate + quality.yml validate-templates + register Test 20 (TEMPLATE-03)
...
- [x] 17-03-PLAN.md — Verify DIST-02 markers intact in commands/audit.md and commands/council.md, stamp real ship date, run make check + make test (DIST-01, DIST-02, DIST-03)
