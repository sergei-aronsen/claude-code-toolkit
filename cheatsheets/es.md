...
| `/learn` | Guardar solucion en `.claude/learned/` para futuras sesiones |
...
| memory-bank | Memoria persistente entre sesiones |
| sequential-thinking | Resolucion paso a paso |
| memory | Grafo de conocimiento para relaciones |
